...
**Mô tả:** Đặt vật phẩm đang cầm làm vật phẩm phong bao cho lì xì vật lý. Lệnh này tự động phát hiện plugin vật phẩm tùy chỉnh bạn đang sử dụng (ItemsAdder, Oraxen hoặc Nexo) và lưu cấu hình.

**Cách dùng:**
```bash
# 1. Lấy vật phẩm tùy chỉnh từ plugin vật phẩm của bạn
/ia get red_envelope    # Ví dụ ItemsAdder
...
Để xem hướng dẫn chi tiết, hãy xem [Hướng dẫn thiết lập vật phẩm phong bao](/vi/guides/set-item/).
...
- Phong bao vật lý (sử dụng dữ liệu database)
